  ...
  <body>
    <header>
      ...
      <div class="open-menu" onclick="openNav()">
        <div class="bar1"><img src="assets/images/bar.png" alt="image to open menu"></div>
        <div class="bar2"><img src="assets/images/bar.png" alt="image to open menu"></div>
        <div class="bar3"><img src="assets/images/bar.png" alt="image to open menu"></div>
      </div>
      <div class="menu">
      ...
      <!-- Button to close the overlay navigation -->
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">
              <div class="container">
                <div class="close-bar1"><img src="assets/images/bar.png" alt="image to close menu"></div>
                <div class="close-bar2"></div>
                <div class="close-bar3"><img src="assets/images/bar.png" alt="image to close menu"></div>
              </div>
            </a>
      <!-- Overlay content -->
